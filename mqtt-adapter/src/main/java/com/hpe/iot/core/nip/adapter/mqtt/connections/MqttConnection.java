...
public interface MqttConnection extends MqttCallback {
	...
	ThreadLocal<MqttConnection> currentConnections = new ThreadLocal<MqttConnection>();
	
	public static MqttConnection getCurrentConn() {    
	    return currentConnections.get();
	}
	
    public static void setCurrentConn(MqttConnection conn) {
